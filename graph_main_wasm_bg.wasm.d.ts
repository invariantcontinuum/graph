...
export const renderengine_pan_by: (a: number, b: number, c: number) => void;
export const renderengine_debug_edge_data: (a: number) => any;
...
export const renderengine_subscribe_edges: (a: number, b: any) => number;
export const renderengine_subscribe_frame: (a: number, b: any) => void;
export const renderengine_unsubscribe_edges: (a: number, b: number) => void;
