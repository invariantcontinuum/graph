...
export const DARK: Palette = {
  ...
  edgeAccents: {
    ...
    enforces: {
      line: "rgba(52, 211, 153, 0.76)",
      arrow: "rgba(52, 211, 153, 0.96)",
    },
    why: {
      line: "rgba(250, 204, 21, 0.78)",
      arrow: "rgba(250, 204, 21, 0.98)",
    },
    drift: {
      line: "rgba(244, 114, 182, 0.58)",
      arrow: "rgba(244, 114, 182, 0.84)",
    },
  },
};
...
export const LIGHT: Palette = {
  ...
  edgeAccents: {
    depends: {
      line: "rgba(8, 145, 178, 0.72)",
      arrow: "rgba(8, 145, 178, 0.92)",
    },
    depends_on: {
      line: "rgba(8, 145, 178, 0.72)",
      arrow: "rgba(8, 145, 178, 0.92)",
    ...
    enforces: {
      line: "rgba(5, 150, 105, 0.74)",
      arrow: "rgba(5, 150, 105, 0.92)",
    },
    why: { line: "rgba(202, 138, 4, 0.76)", arrow: "rgba(202, 138, 4, 0.92)" },
    drift: {
      line: "rgba(219, 39, 119, 0.48)",
      arrow: "rgba(219, 39, 119, 0.72)",
    },
  },
};
