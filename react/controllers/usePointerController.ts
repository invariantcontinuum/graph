...
import { toLocalPointer, centroid, pinchDist, type PointerState } from "./pointerMath";
import { NodeData } from "../types";

interface UsePointerControllerProps {
  canvasRef: React.RefObject<HTMLCanvasElement | null>;
  // Using any to avoid circular import with the WASM pack output
...
export function usePointerController({
  ...
  useEffect(() => {
    ...
    const draggingNodeRef = { current: null as string | null };
  ...
  }, [canvasRef, engineRef, callbacksRef, nodeFromId, flushWorkerMessages, requestRender]);
}
