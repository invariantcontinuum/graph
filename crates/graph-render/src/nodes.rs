...
/// Per-instance floats: center.xy, radius, color.rgba, border_color.rgba, border_width, shape, flags
/// = 2 + 1 + 4 + 4 + 1 + 1 + 1 = 14 floats per instance
pub const NODE_INSTANCE_FLOATS: usize = 14;
