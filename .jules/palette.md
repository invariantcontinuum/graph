...
**Action:** Default to `role="region"` for custom interactive canvas elements instead of `role="application"`. Ensure tooltips via `title` attributes are included on terse action buttons.
