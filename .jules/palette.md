...
## 2026-06-25 - Add Context to External Links for Screen Readers
**Learning:** Links that open in a new tab using `target="_blank"` cause a sudden context switch that can disorient screen reader users if they are not explicitly warned.
