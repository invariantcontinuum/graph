...
| --- | --- | --- | --- |
| 1 | Search and focus API | `GraphHandle.search?`, host utility, or documented `focusFit` pattern | Users need direct node discovery in large graphs |
| 1 | Keyboard navigation | `Graph` keyboard handlers plus host chrome hints | Canvas-first interaction needs non-pointer access |
